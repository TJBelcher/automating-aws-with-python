...
def upload_file(s3_bucket, path, key):
    ...
    print("s3_bucket.upload_file called with:", s3_bucket, path, key, content_type)
...
def sync(pathname, bucket):
    ...
    print('here we are in the sync code with this pathname and bucket:', pathname, bucket)
    s3_bucket = s3.Bucket(bucket)
